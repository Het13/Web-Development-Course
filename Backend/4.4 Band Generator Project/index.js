...
app.post("/submit", (req, res) => {
    ...
    const random_adj_index = Math.floor(Math.random() * adj.length)
    const random_noun_index = Math.floor(Math.random() * noun.length)
    const random_adj = adj[random_adj_index]
    const random_noun = noun[random_noun_index]
    res.render("index.ejs", {noun: random_noun, adj: random_adj})
});
