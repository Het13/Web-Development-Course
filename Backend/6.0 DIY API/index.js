...
app.get('/jokes/:id', (req, res) => {
    const joke_id = parseInt(req.params.id)
...
app.get('/filter', (req, res) => {
    ...
    const filtered_jokes = jokes.filter((joke) => joke.jokeType === joke_type)
    res.json(filtered_jokes)
})
//4. POST a new joke
app.post('/jokes', (req, res) => {
    const joke_type = req.body.type
    const joke_text = req.body.text
    const joke_id = jokes.length + 1;
    jokes.push({
        id: joke_id,
        jokeText: joke_text,
        jokeType: joke_type
...
app.put('/jokes/:id', (req, res) => {
    ...
    const index = jokes.findIndex((joke) => joke.id === joke_id)
...
app.patch('/jokes/:id', (req, res) => {
    const joke_id = parseInt(req.params.id)
    const old_joke = jokes.find((joke) => joke.id === joke_id)
    const new_joke = {
        id: joke_id,
        jokeText: req.body.text || old_joke.jokeText,
        jokeType: req.body.type || old_joke.jokeType
    }
    const index = jokes.findIndex((joke) => joke.id === joke_id)
    jokes[index] = new_joke
    res.json(jokes[index])
